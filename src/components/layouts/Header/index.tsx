  ...
  return (
    <header className="bg-secondary p-3">
      ...
      <div className="container mx-auto w-full justify-end items-center space-x-6 hidden md:flex">
        <NavLink className='text-sm opacity-70 hover:opacity-100 transition' icon={<BsTelephone className='text-xs' />} label="01 55 00 95 95" href="#" />
        <NavLink className='text-sm opacity-70 hover:opacity-100 transition' icon={<BiPencil />} label="Nous contacter" href="#" />
        <NavLink className='text-sm opacity-70 hover:opacity-100 transition' icon={<FaUserAlt className='text-xs' />} label="Espace client" href="#" />
