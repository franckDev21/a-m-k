  ...
  return (
    <React.Fragment>
      <Modal popup size="6xl" show={show} onClose={onClose}>
        <div className="flex py-8 md:min-h-[500px] relative">
          ...
          <div className="w-full md:w-1/2 relative ">
            ...
            <form className="pt-6 md:pt-4 space-y-2">
              ...
              <div className="overflow-hidden  relative bg-white rounded-lg mx-5 sm:mx-10">
                ...
                <div className="flex">
                  <div className="w-[calc(100%-40px)] gap-2 grid grid-cols-3">
                    <select
                      placeholder="Adresse e-mail"
                      className="px-4 py-3 focus:outline-none focus:ring-0 focus:border-0 outline-none shadow-none ring-0 border-0 w-full bg-gray-100"
                    >
